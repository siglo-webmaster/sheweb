...
/**
 * This is the model class for table "pedidosproveedoresentradasalmacenfallados".
 *
 * The followings are the available columns in table 'pedidosproveedoresentradasalmacenfallados':
 ...
 */
class Pedidosproveedoresentradasalmacenfallados extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Pedidosproveedoresentradasalmacenfallados the static model class
	 */
	...
	{
		return 'pedidosproveedoresentradasalmacenfallados';
	}
