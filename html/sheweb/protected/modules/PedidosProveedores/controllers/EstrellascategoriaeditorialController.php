...
class EstrellascategoriaeditorialController extends Controller
{
	/**
	...
	{
		$model=new Estrellascategoriaeditorial;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		if(isset($_POST['Estrellascategoriaeditorial']))
		{
			$model->attributes=$_POST['Estrellascategoriaeditorial'];
			if($model->save())
				$this->redirect(array('view','id'=>$model->idestrellascategoriaeditorial));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('Estrellascategoriaeditorial');
	...
	{
		$model=new Estrellascategoriaeditorial('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Estrellascategoriaeditorial']))
			$model->attributes=$_GET['Estrellascategoriaeditorial'];
	...
	{
		$model=Estrellascategoriaeditorial::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='estrellascategoriaeditorial-form')
		{
