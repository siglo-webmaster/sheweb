...
class Terceros extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('tiposidentificacion_idtiposidentificacion, ciudad_idciudad, nombre, identificacion, estado', 'required'),
			array('tiposidentificacion_idtiposidentificacion, ciudad_idciudad', 'numerical', 'integerOnly'=>true),
			array('nombre', 'length', 'max'=>255),
			array('identificacion, telefono, telefonocontacto, estado', 'length', 'max'=>45),
			array('email, contacto, direccion', 'length', 'max'=>128),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('idterceros, tiposidentificacion_idtiposidentificacion, ciudad_idciudad, nombre, identificacion, telefono, email, contacto, telefonocontacto, direccion, estado', 'safe', 'on'=>'search'),
		);
	}
